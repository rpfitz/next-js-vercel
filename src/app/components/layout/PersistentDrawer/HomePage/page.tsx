      ...
      <div className={styles.pageComponent}>
        <div id="home" className={styles.homePageComponent}>
          <div className={styles.homePageSessionOneComponent}>
            ...
            <h4>Serviços Médicos de Alta Qualidade</h4>
          ...
          <div className={styles.homePageSessionTwoComponent}>
            {/* <Image src={'/VALERIAPH1.jpg'} alt={'Dra. Valéria Siqueira'} width={4000} height={4000} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} /> */}
            {/* <Image src={'/VALERIAPH2.jpg'} alt={'Dra. Valéria Siqueira'} width={4000} height={4000} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} /> */}
            <Image src={'/VALPH.jpg'} alt={'Dra. Valéria Siqueira'} width={300} height={600} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} />
            {/* <Image src={'/femaletransparent.jpg'} alt={'Dra. Valéria Siqueira'} width={1280} height={1024} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} /> */}
            {/* <Image src={'/femaletransparent.jpg'} alt={'Dra. Valéria Siqueira'} width={1280} height={1024} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} /> */}
            {/* <Image src={'/DoutoraValeria.jpg'} alt={'Dra. Valéria Siqueira'} width={1280} height={1024} style={{ maxWidth: '100%', height: '50vh', width: '100%' }} /> */}
          ...
          <div className={styles.faqPageSessionOneComponent}>
            ...
            <div className={styles.faqListComponent}>
              {duvidasFrequentes.map((caso: any, index: any) => {
                return (
                  <Accordion key={index} style={{ margin: '0.5em 0', backgroundColor: 'rgb(163, 120, 42)' }}>
                    <AccordionSummary
